...
import de.savethepub.webapp.config.audit.AuditEventConverter;
import de.savethepub.webapp.domain.PersistentAuditEvent;
...
import static de.savethepub.webapp.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
