...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, de.savethepub.webapp.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, de.savethepub.webapp.repository.UserRepository.USERS_BY_EMAIL_CACHE);
